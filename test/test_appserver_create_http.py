...
class TestAppserverCreateHTTP(boostertest.BoosterTestCase):
    """ Test the appserver-create-http action """

    def setUp(self):
        """ Set the action and other commonly used fixture data """
        self.params = {}
        self.params['action'] = "appserver-create-http"
    ...
    def test_basic_http_appserver_creation_results_in_201(self):
        ...
        params = self.params
        params['appserver-name'] = "http-loops"
        self.teardown_appservers.append("http-loops")
        response, body = self.booster.request(params)
